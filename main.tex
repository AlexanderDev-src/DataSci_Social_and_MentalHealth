...
% ---------------------------------------------------------------
% apacite เป็นข้อยกเว้นของกฎ "hyperref โหลดท้ายสุด" -- ต้องโหลด hyperref ก่อน apacite
% ไม่งั้น \cite ในเนื้อหาจะพังด้วย "Undefined control sequence \hyper@@link"
\usepackage[hidelinks,unicode]{hyperref}
% numberedbib = ให้หัวข้อบรรณานุกรมมีเลขข้อ
